...
<html>
	...
	<body>
		...
		<div id="show-menuCategory" class="content scaffold-show" role="main">
			...
			<g:form url="[resource:menuCategoryInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${menuCategoryInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
